        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('cars/update/' . $car['car_id']) ?>" method="post">
                        <?= csrf_field() ?>
                        
                        <div class="mb-3">
                            <label for="company_id" class="form-label">Company ID</label>
                            <input type="number" class="form-control" id="company_id" name="company_id" 
                                value="<?= old('company_id', $car['company_id']) ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="status" name="status" required>
                                ...
                                <option value="Damaged" <?= old('status', $car['status']) === 'Damaged' ? 'selected' : '' ?>>Damaged</option>
                            </select>
                        </div>
