...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background: url('<?= base_url("public/assets/images/2.png") ?>');
...
<body>
    ...
    <h2 class="text-center">Available Cars for Hertz</h2>
    <div class="row mt-4">
        ...
        <div class="col-md-3 mt-4">
            <div class="card text-center">
                <img src="<?= base_url('public/assets/images/n1.jpg') ?>" class="card-img-top" alt="Nissan Terra">
                <div class="card-body">
                    <h5 class="card-title">Nissan Terra</h5>
                    <p class="text-success">$70/day</p>
                    <button class="btn btn-primary rent-now" data-name="Nissan Terra" data-price="70">Rent Now</button>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mt-4">
            <div class="card text-center">
                <img src="<?= base_url('public/assets/images/n2.jpg') ?>" class="card-img-top" alt="Nissan Navara">
                <div class="card-body">
                    <h5 class="card-title">Nissan Navara</h5>
                    <p class="text-success">$65/day</p>
                    <button class="btn btn-primary rent-now" data-name="Nissan Navara" data-price="65">Rent Now</button>
                </div>
            </div>
        </div>
