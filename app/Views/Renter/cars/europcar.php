...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background: url('<?= base_url("public/assets/images/1.png") ?>');
...
<div class="container mt-5">
    ...
    <h2 class="text-center">Available Cars for Europcar</h2>
    <div class="row mt-4">
        
        <!-- Car Item 1 -->
        <div class="col-md-3">
            <div class="card text-center">
                <img src="<?= base_url('public/assets/images/w.png') ?>" class="card-img-top" alt="Car Image">
                <div class="card-body"><br><br>
                    <h5 class="card-title">Honda Civic</h5>
                    <p class="text-success">$45/day</p>
                    <button class="btn btn-primary rent-now" data-name="Honda Civic" data-price="45">Rent Now</button>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card text-center">
                <img src="<?= base_url('public/assets/images/r.jpg') ?>" class="card-img-top" alt="Car Image">
                <div class="card-body"><br><br>
                    <h5 class="card-title">Chevrolet Malibu</h5>
                    <p class="text-success">$55/day</p>
                    <button class="btn btn-primary rent-now" data-name="Chevrolet Malibu" data-price="55">Rent Now</button>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card text-center">
                <img src="<?= base_url('public/assets/images/q.jpg') ?>" class="card-img-top" alt="Car Image">
                <div class="card-body"><br>
                    <h5 class="card-title">Toyota Camry</h5>
                    <p class="text-success">$50/day</p>
                    <button class="btn btn-primary rent-now" data-name="Toyota Camry" data-price="50">Rent Now</button>
                </div>
            </div>
        </div>

        <!-- Car Item 4 - Not Available -->
        <div class="col-md-3">
            <div class="card text-center">
                <img src="<?= base_url('public/assets/images/e.jpg') ?>" class="card-img-top not-available" alt="Car Image">
                <div class="card-body"><br><br>
